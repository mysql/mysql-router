...
# Private state folder (state_folder configuration option)
if(CMAKE_SYSTEM_NAME STREQUAL "Windows")
  set(_statedir "ENV{APPDATA}")
else()
  set(_statedir ${INSTALL_SECURE_FILE_PRIVDIR})
endif()
set(ROUTER_SECURE_FILE_PRIVDIR ${_statedir} CACHE STRING "Location state files such as keyring file (state_folder)")
unset(_statedir)
